            ...
            <Card className="shadow-lg border-0 p-8">
              ...
              <div className="mb-12">
                <div className="flex items-center mb-6">
                  ...
                  <Title level={2} className="!mb-0">Introduction</Title>
                </div>
                <Paragraph className="text-lg text-gray-700 leading-relaxed">
                  IPO Edge ("we," "our," or "us") is committed to protecting your privacy and ensuring 
              ...
              <div id="information-collection" className="mb-12">
                <div className="flex items-center mb-6">
                  ...
                  <Title level={3} className="!mb-0">Information We Collect</Title>
                </div>
                
                <Title level={4} className="!mb-4 text-blue-600">Personal Information</Title>
                ...
                <Title level={4} className="!mb-4 text-blue-600">Automatically Collected Information</Title>
                <ul className="list-disc list-inside space-y-2 text-gray-700 mb-6">
              ...
              <div id="information-use" className="mb-12">
                <div className="flex items-center mb-6">
                  ...
                  <Title level={3} className="!mb-0">How We Use Your Information</Title>
                </div>
                <Paragraph className="text-gray-700 leading-relaxed mb-4">
                ...
                <ul className="list-disc list-inside space-y-2 text-gray-700 mb-6">
                  ...
                  <li>Send notifications about IPO updates and market insights</li>
              ...
              <div id="information-sharing" className="mb-12">
                <div className="flex items-center mb-6">
                  ...
                  <Title level={3} className="!mb-0">Information Sharing and Disclosure</Title>
                </div>
                <Paragraph className="text-gray-700 leading-relaxed mb-4">
              ...
              <div id="data-security" className="mb-12">
                <div className="flex items-center mb-6">
                  ...
                  <Title level={3} className="!mb-0">Data Security</Title>
                </div>
                <Paragraph className="text-gray-700 leading-relaxed mb-4">
              ...
              <div id="cookies" className="mb-12">
                <Title level={3} className="!mb-4">Cookies and Tracking Technologies</Title>
                <Paragraph className="text-gray-700 leading-relaxed mb-4">
              ...
              <div id="user-rights" className="mb-12">
                <Title level={3} className="!mb-4">Your Rights and Choices</Title>
                <Paragraph className="text-gray-700 leading-relaxed mb-4">
              ...
              <div id="contact-us" className="mb-8">
                <Title level={3} className="!mb-4">Contact Us</Title>
                <Paragraph className="text-gray-700 leading-relaxed mb-4">
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  ...
                  <Text strong>Data Protection Officer:</Text> ipoedge@gmail.com
                </div>
              </div>
